...
class GhbPrefetcher : public Prefetcher
{
   public:
      ...
      std::vector<IntPtr> getNextAddress(IntPtr currentAddress, UInt32 offset, core_id_t core_id, DynamicInstruction *dynins, UInt64 *pointer_loads, IntPtr target_reg);
